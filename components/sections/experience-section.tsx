...
const experiences = [
  ...
  },
  {
    ...
    technologies: ["Python", "Pandas", "Scikit-learn", "Time Series Analysis", "API Integration"],
  },
  {
...
export default function ExperienceSection() {
  ...
  return (
    <section id="experience" ref={containerRef} className="py-20 min-h-screen relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-background to-background/90" />
        <motion.div className="absolute -top-20 -left-20 w-96 h-96 rounded-full bg-primary/5 blur-3xl" style={{ y }} />
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="text-xl text-foreground/80 max-w-2xl mx-auto">
              My professional journey showcases a blend of technical expertise and practical application in machine
              learning, data science, and leadership roles.
            </p>
          </motion.div>
            ...
            {experiences.map((exp, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row gap-8 items-start">
                  ...
                  >
                    <div className="sticky top-20">
                      ...
                      <Badge className="mt-2 bg-primary/10 text-primary border-primary/20">{exp.period}</Badge>
                    </div>
                  </motion.div>
                  ...
                  >
                    <Card className="bg-card/50 backdrop-blur-sm border border-border/30 hover:border-primary/20 transition-colors p-6">
                      <p className="text-lg text-foreground/85 mb-6 leading-relaxed">{exp.description}</p>
                ...
                {index < experiences.length - 1 && (
                  <motion.div
                    className="absolute left-1/3 top-full w-px h-16 bg-border/50 hidden md:block"
                    initial={{ height: 0 }}
